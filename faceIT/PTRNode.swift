...
//  faceIT
//
//  Created by Sean Choe on 4/12/18.
...
class PTRNode: SCNNode {
  let text: String
  
  init(withText text : String, position: SCNVector3) {
    self.text = text
    super.init()
    ...
    material.diffuse.contents = UIImage.init(named: "patreon_logo")
